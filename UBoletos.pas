...
begin
  ...
  Fdm1.tCReceberParcVLRVENCIMENTO.AsFloat   := vlr; //Fdm1.tNotaFiscalParcVLRVENCIMENTO.AsFloat;
  Fdm1.tCReceberParcVLRRESTANTE.AsFloat     := vlr; //Fdm1.tNotaFiscalParcVLRVENCIMENTO.AsFloat;
