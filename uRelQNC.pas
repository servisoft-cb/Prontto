...
procedure TfRelQNC.RLBand8BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  Data2.Caption := 'CAMPO BOM, ' + FormatDateTime('DD' + '" de "' + 'mmmm' + '" de "' + 'YYYY',Date);
  RLMemo7.Lines.Clear;
...
begin
  texto := 'A PRONTTO Centro de Formação de Vigilantes Ltda., inscrita no CNPJ sob o número 09.586.537/0001-50 ' +
           'e Inscrição Estadual número 15227, localizada na Avenida São Leopoldo, 920, Centro, Campo Bom - RS, representada ' +
           'neste ato pelo Sr. Márcio Luís Pereira Flores - Diretor, portador da cédula de identidade número 4067136905, ' +
...
procedure TfRelQNC.RLBand14BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  Data4.Caption := 'CAMPO BOM, ' + FormatDateTime('DD' + '" de "' + 'mmmm' + '" de "' + 'YYYY',Date);
...
procedure TfRelQNC.RLBand10BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  Data3.Caption := 'CAMPO BOM, ' + FormatDateTime('DD' + '" de "' + 'mmmm' + '" de "' + 'YYYY',Date);
  RLMemo9.Lines.Clear;
...
procedure TfRelQNC.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  Data1.Caption := 'CAMPO BOM, ' + FormatDateTime('DD' + '" de "' + 'mmmm' + '" de "' + 'YYYY',Date);
  RLMemo8.Lines.Clear;
