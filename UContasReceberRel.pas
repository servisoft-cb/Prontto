...
procedure TfContasReceberRel.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  vParcReceber := vParcReceber + DmCons.qCReceberParcVLRVENCIMENTO.AsFloat;
...
begin
  vVlrDiaPagto := vVlrDiaPagto + DmCons.qCReceberParcVLRPAGTO.AsFloat;
  vVlrDiaParcela := vVlrDiaParcela +  DmCons.qCReceberParcVLRVENCIMENTO.AsFloat;
  vVlrDiaRestante := vVlrDiaRestante +  DmCons.qCReceberParcVLRRESTANTE.AsFloat;
end;
