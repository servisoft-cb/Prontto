object Dm1: TDm1
  ...
  object Conexao: TSQLConnection
    ...
    Params.Strings = (
      'DriverName=Interbase'
      'Database=d:\fontes\$servisoft\bases\prontto.fdb'
      'RoleName=RoleName'
      'User_Name=sysdba'
      'Password=masterkey'
  ...
  object Pais: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from PAIS'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object Grupo: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from GRUPO'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object SitTributaria: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from SITTRIBUTARIA'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object ClasFiscal: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from CLASFISCAL'#13#10'where CODCLASFISCAL = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
  ...
  object NatOperacao: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from NATOPERACAO'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object Produto: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from PRODUTO'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object ProdutoTam: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from PRODUTOTAM'#13#10'where CODPRODUTO = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object CondPgtoIt: TSQLDataSet
    ...
    GetMetadata = False
    CommandText = 
      'select *'#13#10'from CONDPGTOIT'#13#10'where CODCONDPGTO = :Codigo'#13#10' order b' +
      'y CODCONDPGTO, ITEM'
    MaxBlobSize = -1
    Params = <
      item
  ...
  object tParametro: TClientDataSet
    ...
    object tParametroASSINATURA: TBlobField
      FieldName = 'ASSINATURA'
      Size = 1
    end
    object tParametroJUROS_MES_PERCENT: TFMTBCDField
      FieldName = 'JUROS_MES_PERCENT'
      DisplayFormat = '0.00'
      Precision = 15
      Size = 2
    end
    object tParametroMULTA_PERCENT: TFMTBCDField
      FieldName = 'MULTA_PERCENT'
      DisplayFormat = '0.00'
      Precision = 15
      Size = 2
    end
  ...
  object NotaEntradaIt: TSQLDataSet
    ...
    CommandText = 
      ...
      'TAENTRADAIT.CODFORNECEDOR, '#13#10'NOTAENTRADAIT.ITEM'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object NotaEntradaMObra: TSQLDataSet
    ...
    CommandText = 
      ...
      ' NOTAENTRADAMOBRA.NUMNOTA = :Codigo and'#13#10'   NOTAENTRADAMOBRA.COD' +
  ...
  object TipoCobranca: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from TIPOCOBRANCA'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object MaoObra: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from MAOOBRA'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object Banco: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from BANCO'#13#10'where ID = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object tBanco: TClientDataSet
    ...
    object tBancoACBR_BANCO: TStringField
      FieldName = 'ACBR_BANCO'
      Size = 30
    end
    object tBancoACBR_LAYOUT: TStringField
      FieldName = 'ACBR_LAYOUT'
      FixedChar = True
      Size = 4
    end
    object tBancoACBR_LOGO_BANCO: TStringField
      FieldName = 'ACBR_LOGO_BANCO'
      Size = 200
    end
    object tBancoDIG_AGENCIA: TStringField
      FieldName = 'DIG_AGENCIA'
      Size = 2
    end
    object tBancoCEDENTE: TStringField
      FieldName = 'CEDENTE'
      Size = 15
    end
    object tBancoJUROS_MES: TFMTBCDField
      FieldName = 'JUROS_MES'
      Precision = 15
      Size = 2
    end
    object tBancoMULTA: TFMTBCDField
      FieldName = 'MULTA'
      Precision = 15
      Size = 2
    end
    object tBancoDIAS_PROTESTO: TSmallintField
      FieldName = 'DIAS_PROTESTO'
    end
    object tBancoCARTEIRA: TIntegerField
      FieldName = 'CARTEIRA'
    end
    object tBancoNUM_REMESSA: TSmallintField
      FieldName = 'NUM_REMESSA'
    end
    object tBancoCOD_FEBRABAN: TStringField
      FieldName = 'COD_FEBRABAN'
      Size = 4
    end
    object tBancoCOD_TRANSMISSAO: TStringField
      FieldName = 'COD_TRANSMISSAO'
      Size = 15
    end
    object tBancoOCORRENCIA: TStringField
      FieldName = 'OCORRENCIA'
      Size = 3
    end
    object tBancoINSTRUCAO1: TStringField
      FieldName = 'INSTRUCAO1'
      Size = 3
    end
    object tBancoINSTRUCAO2: TStringField
      FieldName = 'INSTRUCAO2'
      Size = 3
    end
    object tBancoESPECIE: TStringField
      FieldName = 'ESPECIE'
      Size = 3
    end
    object tBancoEND_ARQ_REMESSA: TStringField
      FieldName = 'END_ARQ_REMESSA'
      Size = 200
    end
    object tBancoEXT_ARQ_REMESSA: TStringField
      FieldName = 'EXT_ARQ_REMESSA'
      Size = 3
    end
    object tBancoNOSSONUMERO_POR_ANO: TStringField
      FieldName = 'NOSSONUMERO_POR_ANO'
      FixedChar = True
      Size = 1
    end
    object tBancoTIPO_IMPRESSAO: TStringField
      FieldName = 'TIPO_IMPRESSAO'
      FixedChar = True
      Size = 1
    end
    object tBancoVARIACAO_CARTEIRA: TStringField
      FieldName = 'VARIACAO_CARTEIRA'
      Size = 3
    end
    object tBancoLOCAL_PAGAMENTO: TStringField
      FieldName = 'LOCAL_PAGAMENTO'
      Size = 100
    end
    object tBancoMENSAGEM: TStringField
      FieldName = 'MENSAGEM'
      Size = 30
    end
  end
  ...
  object CPagarParc: TSQLDataSet
    ...
    CommandText = 
      ...
      'DOR = :CODFORNECEDOR and'#13#10' NUMCPAGAR = :NUMCPAGAR and'#13#10' PARCELA ' +
      '= :PARCELA'
    MaxBlobSize = -1
    Params = <
      item
  ...
  object PedidoIt: TSQLDataSet
    ...
    CommandText = 
      ...
      'in PRODUTO on (PRODUTO.ID = PEDIDOIT.CODPRODUTO)'#13#10'where PEDIDOIT' +
      '.NUMLACTO = :P1'#13#10'order by PEDIDOIT.NUMLACTO, PEDIDOIT.ITEM'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
  ...
  object Juros: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from JUROS'#13#10'where ANO = :Ano and MES = :Mes'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object DctoEstoque: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select * '#13#10'from DOCESTOQUE'#13#10'where NUMDOCTO = :CODIGO '
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object ExtComissao: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'select *'#13#10'from EXTCOMISAO'#13#10'where NUMMOV = :Codigo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object Pessoa_Curso: TSQLDataSet
    ...
    object Pessoa_CursoVENDEDOR_ID: TIntegerField
      FieldName = 'VENDEDOR_ID'
    end
    object Pessoa_CursoDTVENDA: TDateField
      FieldName = 'DTVENDA'
    end
    object Pessoa_CursoMOTIVO_DESISTENCIA: TStringField
      FieldName = 'MOTIVO_DESISTENCIA'
      Size = 250
    end
  end
  ...
  object tPessoa_Curso: TClientDataSet
    ...
    object tPessoa_CursoVENDEDOR_ID: TIntegerField
      FieldName = 'VENDEDOR_ID'
    end
    object tPessoa_CursoDTVENDA: TDateField
      FieldName = 'DTVENDA'
    end
    object tPessoa_CursoMOTIVO_DESISTENCIA: TStringField
      FieldName = 'MOTIVO_DESISTENCIA'
      Size = 250
    end
  end
  ...
  object sdsPessoaReajuste: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT * FROM PESSOA_REAJUSTE WHERE ID = :PESSOA'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 512
    Top = 452
    object sdsPessoaReajusteID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object sdsPessoaReajusteITEM: TIntegerField
      FieldName = 'ITEM'
      Required = True
    end
    object sdsPessoaReajusteDATA: TDateField
      FieldName = 'DATA'
    end
    object sdsPessoaReajusteVALOR: TFloatField
      FieldName = 'VALOR'
    end
  end
  object dspPessoaReajuste: TDataSetProvider
    DataSet = sdsPessoaReajuste
    Left = 528
    Top = 452
  end
  object cdsPessoaReajuste: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspPessoaReajuste'
    Left = 544
    Top = 452
    object cdsPessoaReajusteID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object cdsPessoaReajusteITEM: TIntegerField
      FieldName = 'ITEM'
      Required = True
    end
    object cdsPessoaReajusteDATA: TDateField
      FieldName = 'DATA'
    end
    object cdsPessoaReajusteVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '0.00'
    end
  end
  object dsPessoaReajuste: TDataSource
    DataSet = cdsPessoaReajuste
    Left = 552
    Top = 452
  end
  object sdsPessoaCons: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 
      'SELECT P.ID, P.NOME, P.FANTASIA, P.FONE, P.CEL, P.ENDERECO, P.EN' +
      'DNUMERO,'#13#10'P.BAIRRO, C.NOME CIDADENOME, P.ENDCOMPLEMENTO, p.PESSO' +
      'A, P.DOCUMENTO, P.IDENTIDADE,'#13#10'P.DTCADASTRO, P.DTNASCIMENTO, P.N' +
      'UMCARTEIRA, P.STATUS, P.ID_INTERNET,  P.DIAPAGAMENTO'#13#10'FROM PESSO' +
      'A P'#13#10'INNER JOIN CIDADE C ON (P.CIDADE = C.ID)'#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = Conexao
    Left = 484
  ...
  object dspPessoaCons: TDataSetProvider
    DataSet = sdsPessoaCons
    OnUpdateError = PessoaPUpdateError
    Left = 500
    Top = 536
  end
  object cdsPessoaCons: TClientDataSet
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
    ...
    Params = <>
    ProviderName = 'dspPessoaCons'
    StoreDefs = True
    AfterInsert = tPessoaAfterInsert
    Left = 512
    Top = 536
    object cdsPessoaConsID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object cdsPessoaConsNOME: TStringField
      FieldName = 'NOME'
      Size = 40
    end
    object cdsPessoaConsFANTASIA: TStringField
      FieldName = 'FANTASIA'
      Size = 40
    end
    object cdsPessoaConsFONE: TStringField
      FieldName = 'FONE'
      Size = 15
    end
    object cdsPessoaConsCEL: TStringField
      FieldName = 'CEL'
      Size = 15
    end
    object cdsPessoaConsENDERECO: TStringField
      FieldName = 'ENDERECO'
      Size = 40
    end
    object cdsPessoaConsENDNUMERO: TStringField
      FieldName = 'ENDNUMERO'
      Size = 12
    end
    object cdsPessoaConsBAIRRO: TStringField
      FieldName = 'BAIRRO'
      Size = 25
    end
    object cdsPessoaConsCIDADENOME: TStringField
      FieldName = 'CIDADENOME'
      Size = 30
    end
    object cdsPessoaConsENDCOMPLEMENTO: TStringField
      FieldName = 'ENDCOMPLEMENTO'
      Size = 15
    end
    object cdsPessoaConsPESSOA: TStringField
      FieldName = 'PESSOA'
      FixedChar = True
      Size = 1
    end
    object cdsPessoaConsDOCUMENTO: TStringField
      FieldName = 'DOCUMENTO'
      Size = 18
    end
    object cdsPessoaConsIDENTIDADE: TStringField
      FieldName = 'IDENTIDADE'
      Size = 10
    end
    object cdsPessoaConsDTCADASTRO: TDateField
      FieldName = 'DTCADASTRO'
    end
    object cdsPessoaConsDTNASCIMENTO: TDateField
      FieldName = 'DTNASCIMENTO'
    end
    object cdsPessoaConsNUMCARTEIRA: TStringField
      FieldName = 'NUMCARTEIRA'
      Size = 3
    end
    object cdsPessoaConsSTATUS: TStringField
      FieldName = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object cdsPessoaConsID_INTERNET: TIntegerField
      FieldName = 'ID_INTERNET'
    end
    object cdsPessoaConsDIAPAGAMENTO: TIntegerField
      FieldName = 'DIAPAGAMENTO'
    end
  end
  object dsPessoaCons: TDataSource
    DataSet = cdsPessoaCons
    Left = 523
    Top = 536
  end
