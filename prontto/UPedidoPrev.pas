...
var
  fPedidoPrev: TfPedidoPrev;

implementation

uses UDmCons, UOrcamentoPrevRel, UPedidoPrevRel;

{$R *.dfm}

procedure TfPedidoPrev.Monta_SQL;
var
  vTexto : String;
begin
  vTexto := 'WHERE';
  ...
  Resumido.SQL.Add(vTexto + ' PEDIDO.TIPO = ''P''');
  Resumido.SQL.Add(' ORDER BY PEDIDO.DTPEDIDO');
  Resumido.SQL.Text;
  qResumido.Open;
end;

procedure TfPedidoPrev.FormClose(Sender: TObject;
...
procedure TfPedidoPrev.BitBtn3Click(Sender: TObject);
begin
...
procedure TfPedidoPrev.BitBtn1Click(Sender: TObject);
begin
  Monta_SQL;
  fPedidoPrevRel := TfPedidoPrevRel.Create(self);
  fPedidoPrevRel.RlReport1.Preview;
  fPedidoPrevRel.RlReport1.Free;
end;

procedure TfPedidoPrev.FormShow(Sender: TObject);
begin
  qCliente.Open;
end;
