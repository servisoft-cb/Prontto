...
procedure TfContasPagarRel.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  vParcPagar := StrToFloat(FormatFloat('0.00',vParcPagar + DmCons.qCPagarParcVLRVENCIMENTO.AsFloat));
  vRecebido  := StrToFloat(FormatFloat('0.00',vRecebido + DmCons.qCPagarParcVLRPAGTO.AsFloat));
  vAReceber  := StrToFloat(FormatFloat('0.00',vAReceber + DmCons.qCPagarParcVLRRESTANTE.AsFloat));
end;
...
begin
  vVlrDiaPagto    := StrToFloat(FormatFloat('0.00',vVlrDiaPagto + DmCons.qCPagarParcVLRPAGTO.AsFloat));
  vVlrDiaParcela  := StrToFloat(FormatFloat('0.00',vVlrDiaParcela + DmCons.qCPagarParcVLRVENCIMENTO.AsFloat));
  vVlrDiaRestante := StrToFloat(FormatFloat('0.00',vVlrDiaRestante + DmCons.qCPagarParcVLRRESTANTE.AsFloat));
end;
