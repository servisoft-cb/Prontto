object fAlerta: TfAlerta
  ...
  object sdsAvisoEscala: TSQLDataSet
    ...
    GetMetadata = False
    CommandText = 
      'SELECT ED.*, P.NOME CLIENTE, P1.NOME AGENTE'#13#10'FROM ESCALA_DIARIA ' +
      'ED'#13#10'INNER JOIN PESSOA P ON (ED.CLIENTE_ID = P.ID)'#13#10'LEFT JOIN PES' +
      'SOA P1 ON (ED.AGENTE_ID = P1.ID)'#13#10'WHERE ED.DATA = :D1'#13#10'AND HR_IN' +
      'I BETWEEN :H1 AND :H2'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sdsAvisoEscalaAGENTE: TStringField
      FieldName = 'AGENTE'
      ProviderFlags = []
      Size = 40
    end
  ...
  object cdsAvisoEscala: TClientDataSet
    ...
    object cdsAvisoEscalaAGENTE: TStringField
      FieldName = 'AGENTE'
      ProviderFlags = []
      Size = 40
    end
  ...
  object Conexao: TSQLConnection
    ...
    Params.Strings = (
      'DriverName=Interbase'
      'Database=localhost:D:\Fontes\$Servisoft\Prontto\Prontto.fdb'
      'RoleName=RoleName'
      'User_Name=sysdba'
      'Password=masterkey'
