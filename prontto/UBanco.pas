...
uses
  ...
  ExtCtrls, ComCtrls, JvLookup, Grids, DBGrids, JvDBCtrl, DB, JvToolEdit, JvCombobox, UCBase, UDm1, rsDBUtils, JvDBComb,
  SMDBGrid;
...
begin
  ...
  begin
    ...
    ShowMessage('Conta Caixa não pode ser excluída!');
end;

procedure TfBanco.BitBtn5Click(Sender: TObject);
begin
  fDM1.tBancoACBR_LOGO_BANCO.AsString := jvDirectoryEdit1.Text;
  fDM1.tBancoEND_ARQ_REMESSA.AsString := jvDirectoryEdit2.Text;
...
begin
  ...
  case JvComboBox1.ItemIndex of
    ...
    1: DmCons.Banco.SQL.Add('WHERE AGENCIA LIKE ''%' + Edit1.Text + '%''');
  end;
...
begin
  Atualiza;
  jvDirectoryEdit1.Text := fDM1.tBancoACBR_LOGO_BANCO.AsString;
  jvDirectoryEdit2.Text := fDM1.tBancoEND_ARQ_REMESSA.AsString;
end;
