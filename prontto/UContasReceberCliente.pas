         ...
         begin
           if tClienteTotal.Locate('Cliente',qCReceberParcNOME.AsString,[LocaseInsensitive]) then
             begin
               ...
               tClienteTotalSaldoTotal.AsFloat := StrToFloat(FormatFloat('0.00',tClienteTotalSaldoTotal.AsFloat +
                                                  qCReceberParcVLRVENCIMENTO.AsFloat));
               if qCReceberParcDTVENCIMENTO.AsDateTime < JvDateEdit1.Date then
                 tClienteTotalSaldoVencidas.AsFloat := StrToFloat(FormatFloat('0.00',tClienteTotalSaldoVencidas.AsFloat +
                                                       qCReceberParcVLRRESTANTE.AsFloat));
               tClienteTotal.Post;
             end
           else
             begin
               ...
               tClienteTotalCliente.AsString   := qCReceberParcNOME.AsString;
               tClienteTotalSaldoPago.AsFloat  := StrToFloat(FormatFloat('0.00',qCReceberParcVLRPAGTO.AsFloat));
               tClienteTotalSaldoTotal.AsFloat := StrToFloat(FormatFloat('0.00',qCReceberParcVLRVENCIMENTO.AsFloat));
               if qCReceberParcDTVENCIMENTO.AsDateTime < JvDateEdit1.Date then
                 tClienteTotalSaldoVencidas.AsFloat := StrToFloat(FormatFloat('0.00',qCReceberParcVLRRESTANTE.AsFloat));
               tClienteTotal.Post;
             end;
           qCReceberParc.Next;
         end;
       ...
       while not qAvencer.Eof do
         begin
           if tClienteTotal.Locate('Cliente',qAvencerNOME.AsString,[LocaseInsensitive]) then
             begin
               tClienteTotal.Edit;
               tClienteTotalSaldoVencer.AsFloat := StrToFloat(FormatFloat('0.00',tClienteTotalSaldoVencer.AsFloat + qAvencerVLRRESTANTE.AsFloat));
               tClienteTotalSaldoTotal.AsFloat  := StrToFloat(FormatFloat('0.00',tClienteTotalSaldoTotal.AsFloat + qAvencerVLRVENCIMENTO.AsFloat));
               tClienteTotal.Post;
             end
           else
             begin
               tClienteTotal.Insert;
               tClienteTotalSaldoVencer.AsFloat := StrToFloat(FormatFloat('0.00',qAvencerVLRRESTANTE.AsFloat));
               tClienteTotalSaldoTotal.AsFloat  := StrToFloat(FormatFloat('0.00',qAvencerVLRVENCIMENTO.AsFloat));
               tClienteTotal.Post;
             end;
           qAvencer.Next;
         end;
