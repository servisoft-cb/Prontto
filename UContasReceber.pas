...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Math, StdConvs, UDm1,
  Dialogs, Grids, DBGrids, JvDBCtrl, ExtCtrls, ComCtrls, StdCtrls, Buttons, JvLookup, DBCtrls, Mask, DB, FMTBcd,
  SqlExpr, JvToolEdit, JvCurrEdit, DBXpress, DBClient, Provider, JvCombobox, JvEdit, JvTypedEdit, JvComponent,
  JvColorBox, Menus, JvBitBtn, JvxCtrls, JvDBComb;
...
begin
  result := fdm1.tCReceberParcVLRVENCIMENTO.AsCurrency;
  fdm1.tCReceberDiscrim.First;
  while not fdm1.tCReceberDiscrim.Eof do
  begin
    result := result - fdm1.tCReceberDiscrimVALOR.AsCurrency;
    fdm1.tCReceberDiscrim.Next;
  end;
end;
