...
begin
  ...
  RLMemo2.Lines.Text := RLMemo2.Lines.Text + ' O CENTRO DE FORMAÇÃO ministrará aulas com o objetivo de formar, aperfeiçoar e capacitar profissionais para o desempenho das funções na área de segurança privada, conforme disposições contidas' +
                        '  na Portaria nº 387 de 01 de setembro de 2006 do Departamento de Polícia Federal.';
  RLMemo2.Lines.Add('');
  ...
  RLMemo2.Lines.Text := RLMemo2.Lines.Text + '  As partes elegem o Foro da cidade de Campo Bom/RS para dirimir quaisquer controvérsias oriundas do presente instrumento.';
end;
